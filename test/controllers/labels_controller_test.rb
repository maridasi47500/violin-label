...
class LabelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create label" do
    assert_difference("Label.count") do
      post labels_url, params: { label: { annee: @label.annee, content: @label.content, manufacturer: @label.manufacturer, model: @label.model } }
    end
  ...
  test "should update label" do
    patch label_url(@label), params: { label: { annee: @label.annee, content: @label.content, manufacturer: @label.manufacturer, model: @label.model } }
